...
// will hold all the tetris shapes
let tetrominos = [];

//colors of all arrays from tetris game.
let tetrominosColors = ['#F9C6D7', '#DB4C77', '#10559A', '#3CA2C8', '#094242', '#083030', '#215473']

//holds all colors.
let curTetrominoColor;

//creates gameboard array so we know where the squares are
...
function SetupCanvas() {
  ...
  tetrisLogo = new Image(181, 54);
  tetrisLogo.onload = DrawTetrisLogo;
  tetrisLogo.src = 'tetrisLogo.jpeg';
  ...
  ctx.fillText('E : Rotating Right', 310, 463);
  // ctx.fillText('F : Rotating Left', 310, 488);
